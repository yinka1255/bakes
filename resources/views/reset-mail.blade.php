                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-infoblock" align="left">
                                                                                        <p>Nigeria's no1. job platform</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="268" align="left">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-m-p0l es-m-txt-c es-p15t" align="left"><a href target="_blank"><img src="http://Sellr.com/public/admin/images/logo-icon.jpg" alt width="80" style="display: block;"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="272" align="left">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p10t es-m-txt-c" align="right"><span class="es-button-border" style="border-radius: 4px; padding:4px; border-width: 1px; border-color: rgb(0, 0, 255); background: rgb(255, 255, 255);"><a href="https://Sellr.com/contact/" class="es-button" target="_blank" style="border-radius: 4px; padding:4px; border-width: 1px; border-color: rgb(0, 0, 255); background: rgb(255, 255, 255);">Contact us</a></span></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                                    ...
                                                                                    <td>
                                                                                        <table class="es-table-not-adapt" cellspacing="0" cellpadding="0">
                                                                                            <tbody>
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td align="left" esd-links-underline="none" class="esd-block-text">
                                                                                                                        <p><strong><a target="_blank" href="tel:+234 802 996 8586" style="text-decoration: none;">+234 802 996 8586</a></strong></p>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                                                                                    ...
                                                                                                    <td align="left">
                                                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td align="left" esd-links-underline="none" class="esd-block-text">
                                                                                                                        <p><strong><a target="_blank" href="mailto:hmd@Sellr.com" style="text-decoration: none;">hmd@Sellr.com</a></strong></p>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="esd-block-image es-p5t es-p5b es-p5r" valign="top" align="left"><a href target="_blank"><img src="https://tlr.stripocdn.email/content/guids/CABINET_d6b02eef486e424923e42d33952bbae0/images/9911561457458673.png" alt width="21" style="display: block;"></a></td>
                                                                                                    <td align="left">
                                                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td align="left" esd-links-underline="none" class="esd-block-text">
                                                                                                                        <p style="color: rgb(0, 0, 255);"><strong>Okposi, Ebonyi State.</strong></p>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
